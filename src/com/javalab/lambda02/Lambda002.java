...
public class Lambda002 { // class s
	...
	public static void main(String[] args) { // main s
		...
		// 익명 구현 클래스 정의와 동시에 객체 생성
			...
			@Override	// 부모 인터페이스가 갖고 있는 max()메소드 오버라이딩
